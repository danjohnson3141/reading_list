...
ActiveRecord::Schema.define(version: 20140716174904) do
  ...
  add_index "book_club_books", ["book_club_id"], name: "index_book_club_books_on_book_club_id"
  add_index "book_club_books", ["book_id"], name: "index_book_club_books_on_book_id"
